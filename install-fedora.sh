# install require
sudo dnf install picom polybar bspwm sxhkd alacritty rofi nodejs brightnessctl pulseaudio zsh curl stow ripgrep chsh python3-pip xprop htop --skip-broken
# set time
