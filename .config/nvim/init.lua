...
vim.keymap.set('n', '<C-i>', require('telescope.builtin').oldfiles, {
    desc = '[?] Find recently opened files'
})
vim.keymap.set('n', '<C-a>', require('telescope.builtin').buffers, {
...
local on_attach = function(_, bufnr)
    ...
    nmap('<C-o>', require('telescope.builtin').lsp_document_symbols, '[D]ocument [S]ymbols')
